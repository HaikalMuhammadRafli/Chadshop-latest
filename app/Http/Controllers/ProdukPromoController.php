...
class ProdukPromoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $itempromo = ProdukPromo::orderBy('id','desc')
    ...
    public function store(Request $request)
    {
        ...
        $cekeventdetail = EventDetail::where('produk_id', $request->produk_id)->first();
        $cekpromo = ProdukPromo::where('produk_id', $request->produk_id)->first();
        if ($cekeventdetail) {
            return back()->with('error', 'Produk sudah ditambahkan ke dalam event promo');
        } else {
            if ($cekpromo) {
