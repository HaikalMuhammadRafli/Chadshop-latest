            ...
            <div class="card-body">
                <form action="{{ route('kontak.store') }}" method="POST">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="gender" id="gender-1" value="Pria">
                        <label class="form-check-label" for="gender-1">
                            Pria
                        </label>
                    </div>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="gender" id="gender-2" value="Wanita">
