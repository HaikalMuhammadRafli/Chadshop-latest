              ...
              <tr>
                ...
                <td>
                  <select name="status_penerimaan" id="status_penerimaan" class="form-control">
                    <option value="sudah" {{ $itemorder->cart->status_penerimaan == 'sudah' ? 'selected':'' }}>Sudah</option>
                    <option value="belum" {{ $itemorder->cart->status_penerimaan == 'belum' ? 'selected':'' }}>Belum</option>
                  </select>
                </td>
              </tr>
              <tr>
