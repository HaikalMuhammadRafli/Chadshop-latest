          ...
          <div class="card-body box-profile">
            <div class="text-center">
              @if(Auth::user()->foto != null)
                  <img src="{{ \Storage::url(Auth::user()->foto) }}" alt="profil" class="profile-user-img img-responsive img-circle shadow">
              @else
        ...
        <div class="card card-primary card-outline">
          <div class="card-body">
            ...
            <form action="{{ route('profil.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <button type="submit" class="btn btn-primary btn-block w-100">Update User Info</button>
            </form>
          </div>
        </div>
      </div>
